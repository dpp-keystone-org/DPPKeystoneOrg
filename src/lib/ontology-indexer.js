...
export async function buildIndex() {
    ...
    for (const [key, value] of ontologyMap.entries()) {
        ...
        if (value.definedIn) {
            ...
            contextDocUrl = `../spec/ontology/{{VERSION}}/${modType}/${modName}/index.html`;
            ...
            if (isClass) {
                docUrl = `../spec/ontology/{{VERSION}}/${modType}/${modName}/${key}.html`;
            } else {
                // Properties are anchored in the module index
                docUrl = `../spec/ontology/{{VERSION}}/${modType}/${modName}/index.html#${key}`;
            }
        }
        ...
        if (value.domain) {
            ...
            if (domainClass && domainClass.definedIn) {
                ...
                domainDocUrl = `../spec/ontology/{{VERSION}}/${dType}/${dName}/${domainKey}.html`;
            }
        }
