...
import Papa from '../lib/vendor/papaparse.js?v=1783063966348';
import { loadSchema, flattenSchema } from '../lib/schema-loader.js?v=1783063966348';
import { loadOntology } from '../lib/ontology-loader.js?v=1783063966348';
import { generateDPPsFromCsv, generateAutoMapping, findUsedIndices, generateIndexedSuggestions, analyzeColumnData, isTypeCompatible, enrichSchemaWithOntology, validateMappingConstraints, getMissingRequiredFields, validateValue } from '../lib/csv-adapter-logic.js?v=1783063966348';
