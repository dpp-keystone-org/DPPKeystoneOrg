import { loadOntology } from './ontology-loader.js?v=1781526840057';
...
export async function buildIndex() {
    ...
    for (const [key, value] of ontologyMap.entries()) {
        ...
        if (value.definedIn) {
            ...
            contextDocUrl = `../spec/ontology/v2/${modType}/${modName}/index.html`;
            ...
            if (isClass) {
                docUrl = `../spec/ontology/v2/${modType}/${modName}/${key}.html`;
            } else {
                // Properties are anchored in the module index
                docUrl = `../spec/ontology/v2/${modType}/${modName}/index.html#${key}`;
            }
        }
        ...
        if (value.domain) {
            ...
            if (domainClass && domainClass.definedIn) {
                ...
                domainDocUrl = `../spec/ontology/v2/${dType}/${dName}/${domainKey}.html`;
            }
        }
