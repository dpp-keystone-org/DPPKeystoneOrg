import { loadOntology } from './ontology-loader.js?v=1783267426364';
...
export async function buildIndex() {
    ...
    for (const [key, value] of ontologyMap.entries()) {
        ...
        if (value.definedIn) {
            ...
            contextDocUrl = `../spec/ontology/v3/${modType}/${modName}/index.html`;
            ...
            if (isClass) {
                docUrl = `../spec/ontology/v3/${modType}/${modName}/${key}.html`;
            } else {
                // Properties are anchored in the module index
                docUrl = `../spec/ontology/v3/${modType}/${modName}/index.html#${key}`;
            }
        }
        ...
        if (value.domain) {
            ...
            if (domainClass && domainClass.definedIn) {
                ...
                domainDocUrl = `../spec/ontology/v3/${dType}/${dName}/${domainKey}.html`;
            }
        }
