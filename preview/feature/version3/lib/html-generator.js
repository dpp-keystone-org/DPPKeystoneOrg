import { renderProductPage, detectTableStructure } from '../util/js/common/rendering/dpp-html-renderer.js?v=1790158527830';
...
export async function generateHTML(dppJson, optionsOrCssUrl) {
  ...
  if (includeSchema) {
    try {
      ...
      const { transformDpp } = await import('../util/js/client/dpp-schema-adapter.js?v=1790158527830');
  ...
  try {
    const { loadOntology } = await import('./ontology-loader.js?v=1790158527830');
    let sector = 'dpp';
