...
import { transformDpp } from '../util/js/server/dpp-schema-adapter.js?v=1788856171210';
import { getProductPageCss, getServerOntologyMap, createServerDocumentLoader } from './server-resource-loader.js?v=1788856171210';
