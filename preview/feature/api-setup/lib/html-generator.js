import { renderProductPage, detectTableStructure } from '../util/js/common/rendering/dpp-html-renderer.js?v=1788853271333';
import { KEYSTONE_VERSION } from './keystone-version.js?v=1788853271333';
...
export async function generateHTML(dppJson, optionsOrCssUrl) {
  ...
  if (includeSchema) {
    try {
      ...
      const { transformDpp } = await import('../util/js/client/dpp-schema-adapter.js?v=1788853271333');
  ...
  try {
    const { loadOntology } = await import('./ontology-loader.js?v=1788853271333');
    let sector = 'dpp';
