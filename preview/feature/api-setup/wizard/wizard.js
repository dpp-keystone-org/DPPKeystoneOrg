...
import { loadHeader } from '../branding/header.js?v=1788854243575';
loadHeader('dpp-header-container', '..');
import { loadSchema } from '../lib/schema-loader.js?v=1788854243575';
import { loadOntology, loadContext } from '../lib/ontology-loader.js?v=1788854243575';
import { buildForm, createVoluntaryFieldRow } from './form-builder.js?v=1788854243575';
import { generateDpp } from './dpp-generator.js?v=1788854243575';
import { generateHTML } from '../lib/html-generator.js?v=1788854243575';
import { transformDpp } from '../util/js/client/dpp-schema-adapter.js?v=1788854243575';
import * as jsonld from 'jsonld';
import { KEYSTONE_VERSION } from '../lib/keystone-version.js?v=1788854243575';
import { LanguageManager } from '../lib/language-manager.js?v=1788854243575';
