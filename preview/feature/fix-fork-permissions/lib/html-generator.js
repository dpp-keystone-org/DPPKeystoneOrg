import { renderProductPage, detectTableStructure } from '../util/js/common/rendering/dpp-html-renderer.js?v=1788267102955';
import { KEYSTONE_VERSION } from './keystone-version.js?v=1788267102955';
...
export async function generateHTML(dppJson, optionsOrCssUrl) {
  ...
  if (includeSchema) {
    try {
      ...
      const { transformDpp } = await import('../util/js/client/dpp-schema-adapter.js?v=1788267102955');
  ...
  try {
    const { loadOntology } = await import('./ontology-loader.js?v=1788267102955');
    let sector = 'dpp';
