import { renderProductPage, detectTableStructure } from '../util/js/common/rendering/dpp-html-renderer.js?v=1777899959191';
...
export async function generateHTML(dppJson, optionsOrCssUrl) {
  ...
  if (includeSchema) {
    try {
      ...
      const { transformDpp } = await import('../util/js/client/dpp-schema-adapter.js?v=1777899959191');
  ...
  try {
    const { loadOntology } = await import('./ontology-loader.js?v=1777899959191');
    let sector = 'dpp';
