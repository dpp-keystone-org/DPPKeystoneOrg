import { validateDpp } from '../util/js/common/validation/schema-validator.js?v=1777643941067';
import stripJsonComments from 'strip-json-comments';
import { EXAMPLES } from '../lib/example-registry.js?v=1777643941067';
import { generateHTML } from '../lib/html-generator.js?v=1777643941067';
import { transformDpp } from '../util/js/client/dpp-schema-adapter.js?v=1777643941067';
...
import { validateAgainstOntology } from '../util/js/common/validation/ontology-validator.js?v=1777643941067';
import { validateContextAwarePayload } from '../util/js/common/validation/context-semantic-validator.js?v=1777643941067';
