...
import { renderProductPage, detectTableStructure } from '../../../src/util/js/common/rendering/dpp-html-renderer.js';
import { transformDpp } from '../../../src/util/js/server/dpp-schema-adapter.js';
import { getProductPageCss, getServerOntologyMap, createServerDocumentLoader } from './server-resource-loader.js';
