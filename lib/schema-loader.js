...
export async function loadSchema(schemaName, schemaType) {
    ...
    if (schemaType === 'header') {
        schemaPath = `../spec/validation/v2/json-schema/${schemaName}.schema.json`;
    } else if (schemaType === 'shared') {
        schemaPath = `../spec/validation/v2/json-schema/shared/${schemaName}.schema.json`;
    } else if (schemaType === 'sector') {
        schemaPath = `../spec/validation/v2/json-schema/sector/${schemaName}.schema.json`;
    } else {
