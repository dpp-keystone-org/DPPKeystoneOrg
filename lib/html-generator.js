import { renderProductPage, detectTableStructure } from '../util/js/common/rendering/dpp-html-renderer.js?v=1773653170584';
...
export async function generateHTML(dppJson, optionsOrCssUrl) {
  ...
  if (includeSchema) {
    try {
      ...
      const { transformDpp } = await import('../util/js/client/dpp-schema-adapter.js?v=1773653170584');
  ...
  try {
    const { loadOntology } = await import('./ontology-loader.js?v=1773653170584');
    let sector = 'dpp';
