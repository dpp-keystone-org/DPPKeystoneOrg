import { renderProductPage, detectTableStructure } from '../util/js/common/rendering/dpp-html-renderer.js?v=1769506534837';
...
export async function generateHTML(dppJson, customCssUrl) {
  ...
  try {
      ...
      const { transformDpp } = await import('../util/js/client/dpp-schema-adapter.js?v=1769506534837');
