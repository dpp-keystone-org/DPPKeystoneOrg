...
*   **`shacl-fuzzer.mjs`**: Core engine for SHACL meta-validation fuzzing. Parses ontology class requirements, synthesizes valid test RDF graphs, and generates mutated graphs to test shape constraints.
